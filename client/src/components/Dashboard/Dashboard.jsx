...
function Dashboard() {
  ...
  return (
    <div className='flex justify-between items-center lg:mx-16 mt-8'>
      <div className='mx-auto'>Welcome {userInfo.role}, <span className='font-bold text-primaryColor'>{userInfo.name}</span></div>
          ...
          <>
            ...
            <label className="btn btn-ghost btn-circle avatar">
              <div className="w-16  rounded-full">
                <img title={userInfo.name} src={userInfo.image} />
              </div>
            </label>
